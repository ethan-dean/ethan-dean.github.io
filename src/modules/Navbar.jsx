function Navbar() {
  ...
  return (
    <header className="bg-gray-200 fixed top-0 w-screen flex flex-nowrap justify-between align-middle p-2  border-b border-gray-600">
        <a href="#about">
        ...
        <div className="hidden md:flex">
          <a className="flex items-center text-black no-underline mr-3">About</a>
          <a className="flex items-center text-black no-underline mr-3">Projects</a>
          <a className="flex items-center text-black no-underline mr-3">Contact</a>
        ...
        <div className="flex md:hidden flex-col justify-between h-18 p-3">
          <input type="checkbox" className="fixed z-10 top-4 right-5 w-8 h-8 opacity-0
                                            peer" />

          <span className="w-8 h-1 bg-black rounded-sm 
                           transition-all peer-checked:rotate-45 peer-checked:translate-y-[10px]" />
          <span className="w-8 h-1 bg-black rounded-sm 
                           transition-all peer-checked:scale-x-0" />
          <span className="w-8 h-1 bg-black rounded-sm
                           transition-all peer-checked:-rotate-45 peer-checked:-translate-y-[10px]" />

          <ul className="bg-gray-200 fixed z-50 top-[65px] -right-56 h-screen w-56 p-4 pl-6
                          transition-all peer-checked:-translate-x-56">
